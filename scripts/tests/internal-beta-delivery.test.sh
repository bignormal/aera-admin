...
require_text deploy/compose.internal-beta.yaml 'AERA_ADMIN_HEALTH_CHECKS_ENABLED:-false'
...
require_text deploy/internal-beta/gateway.mjs 'AERA_ADMIN_HEALTH_CHECKS_ENABLED'

...
import { createSkill, deleteSkill, listSkills, updateSkill, type SkillInput } from '@/service/skills';
...
<template>
  <ResourceCrudPage
    ...
    :fields="[
      ...
      { key: 'runtimeSkillId', label: 'Runtime 技能标识', required: true },
      { key: 'minimumRuntimeVersion', label: '最低 Runtime 版本' },
      { key: 'description', label: '说明', type: 'textarea' },
      { key: 'active', label: '启用', type: 'switch' }
    ]"
    :defaults="{ _status: 'draft', active: true }"
    :list="list"
    :create="create"
    :update="update"
    :remove="remove"
